...
<body>
  ...
  <!-- Ajoutez ces fichiers dans le <head> de votre HTML si ce n'est pas déjà fait -->
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <div class="search-box bg-dark position-relative">
    <div class="search-wrap">
      ...
      <form id="search-form" class="text-lg-center text-md-left pt-3" action="index.php" method="get">
        <input type="text" name="search" class="search-input" placeholder="Search...">
        <button type="submit" class="search-btn" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex; align-items: center; justify-content: center;">
          <svg class="search">
            ...
            <div class="summary">
              <div class="summary-content fs-6">
                <div class="product-header d-flex justify-content-between mt-4">
                  <h3 class="display-7">pour hommes 70£</h3>
                  <div class="modal-close-btn">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    </button>
                  </div>
                </div>
                <span class="product-price fs-3">70£</span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mini-cart-total d-flex justify-content-between py-4">
          ...
          <span class="special-price-code" id="cart-total">€0.00</span>
        </div>
        <div class="modal-footer my-4 justify-content-center">
  <!-- Ajout total dans URL -->      
          </div>
          <div class="modal-footer my-4 justify-content-center">
        </div>
      </div>
            ...
            <div class="col-lg-12 mx-auto">
              ...
              <form id="login-form" action="login.php" method="POST">
                ...
                <input type="password" name="password" id="password" placeholder="Password"
                  class="ps-3 text-input" required>
                <!-- Option 'Se souvenir de moi' -->
                <div class="checkbox d-flex justify-content-between mt-4">
                  <p class="checkbox-form">
                    <label>
                      <input name="rememberme" type="checkbox" id="remember-me" value="forever"> Se souvenir de moi
                    </label>
                  </p>
                ...
                <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modallogin">
                  Se connecter
                </button>
...
{
  echo "<div style='background-color: lightblue;'>Bienvenue monsieur ".$_SESSION['username']."</div>";
}

if (isset($_GET['search'])&&!empty($_GET['search'])) {
    $searchTerm = $_GET['search'];
    echo "<div style='background-color: green; color: white; padding: 20px; border-radius: 10px; width: 100%; margin: 20px auto; text-align: center;'>";
    $searchTerm = htmlspecialchars($_GET['search'], ENT_QUOTES, 'UTF-8');
    echo "Résultats de la recherche pour : " . $searchTerm . "</div>";
}
?>
    <nav id="header-nav" class="navbar navbar-expand-lg">
      ...
      <div class="container-lg">
        ...
        <a class="navbar-brand" href="index.php">
          <img src="images/main-logo.png" class="logo" alt="logo" style="width: 200px; height: auto;">
        </a>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
          ...
          <div class="offcanvas-body">
            <ul id="navbar" class="navbar-nav fw-bold justify-content-end align-items-center flex-grow-1">
              ...
              <li class="nav-item">
                <a class="nav-link me-5" href="#">Hommes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-5" href="#">Femme</a>
              </li>
        ...
        <div class="user-items ps-0 ps-md-5">
          ...
          <?php if (!isset($_SESSION['username'])) {
            ...
            ?>
            <li class="pe-3">
            <a href="logout.php" class="border-0">
            Logout
        </a>
            </li>
             <?php
  ...
  <div class="container-md">
    <div class="display-header d-flex align-items-center justify-content-between">
      <h2 class="section-title text-uppercase">Vêtements Sportifs</h2>
    </div>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
        ...
        <div class="col mb-4">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item1.jpg" alt="Maillot de skate" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Maillot de skate', 64.99)">
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Maillot de skate</h3>
              <span class="card-price fw-bold">64,99 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item2.jpg" alt="Nike Air Max Dn8" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Nike Air Max Dn8', 189.99)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Nike Air Max Dn8</h3>
              <span class="card-price fw-bold">189,99 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item3.jpg" alt="Nike Air Max Plus" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Nike Air Max Plus', 189.99)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Nike Air Max Plus</h3>
              <span class="card-price fw-bold">189,99 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item4.jpg" alt="Jordan Brooklyn" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Jordan Brooklyn', 56.00)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Jordan Brooklyn</h3>
              <span class="card-price fw-bold">56,00 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item5.jpg" alt="Jordan Brooklyn Fleece" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Jordan Brooklyn Fleece', 54.00)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Jordan Brooklyn Fleece</h3>
              <span class="card-price fw-bold">54,00 €</span>
            </div>
          </div>
        </div>
      </div>
...
<section id="latest-products" class="product-store py-2 my-2 py-md-5 my-md-5 pt-0">
  <div class="container-md">
    <div class="display-header d-flex align-items-center justify-content-between">
      <h2 class="section-title text-uppercase">Compléments alimentaires</h2>
    </div>
    <div class="product-content padding-small">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5">
        <!-- Produit 6 -->
        <div class="col mb-4 mb-3">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item6.jpg" alt="MASS HARDCORE" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('MASS HARDCORE', 89.90)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">MASS HARDCORE</h3>
              <span class="card-price fw-bold">89,90 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4 mb-3">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item7.jpg" alt="Muscle mass" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('Muscle mass', 79.99)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">Muscle mass</h3>
              <span class="card-price fw-bold">79,99 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4 mb-3">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item8.jpg" alt="hydro isolate" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('hydro isolate', 94.90)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">hydro isolate</h3>
              <span class="card-price fw-bold">94,90 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4 mb-3">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item9.jpg" alt="collagen max" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('collagen max', 49.90)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">collagen max</h3>
              <span class="card-price fw-bold">49,90 €</span>
            </div>
          </div>
        </div>
        ...
        <div class="col mb-4 mb-3">
          <div class="product-card position-relative">
            <div class="card-img">
              <img src="images/card-item10.jpg" alt="VITAMIN C MAX" class="product-image img-fluid">
              <div class="cart-concern position-absolute d-flex justify-content-center">
                <div class="cart-button d-flex gap-2 justify-content-center align-items-center">
                  <button type="button" class="btn btn-light" onclick="addToCart('VITAMIN C MAX', 13.90)">
                    <svg class="shopping-carriage">
                      <use xlink:href="#shopping-carriage"></use>
                    </svg>
                  </button>
            ...
            <div class="card-detail d-flex justify-content-between align-items-center mt-3">
              <h3 class="card-title fs-6 fw-normal m-0">VITAMIN C MAX</h3>
              <span class="card-price fw-bold">13,90 €</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="footer" class="py-5 border-top">
    <div class="container-lg">
        ...
        <div class="col-lg-2 pb-3">
          <div class="footer-menu">
            ...
            <div class="footer-contact-text">
              <span> SPORTS STORE 123 Main Street, Toulouse - France. </span>
              <span> Appelez-nous: (+33) 800 433 789-987 </span>
              <span class="text-hover fw-bold light-border"><a href="mailto:contact@nike-factory-store.com">contact@SPORTS-STORE.com</a></span>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
          <p>© Copyright SPORTS STORE 2025.</p>
        </div>
